...
public class PCServerEntityPositionRotationPacketTranslator implements IPacketTranslator<ServerEntityPositionRotationPacket> {
    @Override
    public void translate(BedrockSession<UpstreamSession> session, ServerEntityPositionRotationPacket packet) {
