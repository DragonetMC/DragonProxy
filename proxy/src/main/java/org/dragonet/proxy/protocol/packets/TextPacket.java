...
public class TextPacket extends PEPacket {
    ...
    public final static int TYPE_RAW = 0;
    public final static int TYPE_CHAT = 1;
    public final static int TYPE_TRANSLATION = 2;
    public final static int TYPE_POPUP = 3;
    public final static int TYPE_JUKEBOX_POPUP = 4;
    public final static int TYPE_TIP = 5;
    public final static int TYPE_SYSTEM = 6;
    public final static int TYPE_WHISPER = 7;
    public final static int TYPE_ANNOUNCEMENT = 8;
