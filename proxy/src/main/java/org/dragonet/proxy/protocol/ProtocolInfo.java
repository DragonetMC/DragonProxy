...
public class ProtocolInfo {
	 ...
	 */
	public static final int CURRENT_PROTOCOL = 150;
	/**
	 * Current Minecraft PE version reported by the server. This is usually the
	 * earliest currently supported version.
	 */
	public static final String MINECRAFT_VERSION = "v1.2.6";
	/**
	 * Version number sent to clients in ping responses.
	 */
	public static final String MINECRAFT_VERSION_NETWORK = "1.2.6";
