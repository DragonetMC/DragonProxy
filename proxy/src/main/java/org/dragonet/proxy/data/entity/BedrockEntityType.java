...
public enum BedrockEntityType {
    ...
    PARROT(30, 0.9f, 0.5f),
    DOLPHIN(31, 0f), //TODO
    ZOMBIE(32, 1.8f, 0.6f, 1.62f),
    CREEPER(33, 1.7f, 0.6f, 1.62f),
    SKELETON(34, 1.8f, 0.6f, 1.62f),
    SPIDER(35, 0.9f, 1.4f,1f),
    ZOMBIE_PIGMAN(36, 1.8f, 0.6f, 1.62f),
    SLIME(37, 0.51f),
    ...
    MAGMA_CUBE(42, 0.51f),
    BLAZE(43, 1.8f, 0.6f),
    ZOMBIE_VILLAGER(44, 1.8f,0.6f,  1.62f),
    WITCH(45, 1.8f, 0.6f, 1.62f),
    STRAY(46, 1.8f, 0.6f, 1.62f),
    HUSK(47, 1.8f, 0.6f, 1.62f),
    WITHER_SKELETON(48, 2.4f, 0.7f),
    GUARDIAN(49, 0.85f),
    ELDER_GUARDIAN(50, 1.9975f),
    NPC(51, 1.8f, 0.6f, 1.62f),
    WITHER(52, 3.5f, 0.9f),
    ENDER_DRAGON(53, 4f, 13f),
    SHULKER(54, 1f, 1f),
    ENDERMITE(55, 0.3f, 0.4f),
    AGENT(56, 0f),
    VINDICATOR(57, 1.8f, 0.6f,1.62f),
    PILLAGER(114, 1.8f, 0.6f, 1.62f),
    WANDERING_TRADER(118, 1.8f, 0.6f, 1.62f),
