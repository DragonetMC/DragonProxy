...
public final class BedrockToJavaIngameConverter extends BedrockToJavaTranslator {
    public static final BedrockToJavaIngameConverter INSTANCE = new BedrockToJavaIngameConverter();

    private BedrockToJavaIngameConverter() {
        if(INSTANCE != null) {
